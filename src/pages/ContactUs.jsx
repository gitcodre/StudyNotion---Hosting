...
const ContactUs = () => {
  return (
    <div>
        <div className='w-[11/12] max-w-maxContent mx-auto mt-20 flex justify-between'>
            <div className='bg-richblack-800 flex flex-col gap-10 text-richblack-5 p-8 rounded-md pr-[8rem] h-fit'>
            ...
            <div className='w-[58%] flex flex-col p-10 gap-2 text-richblack-5 border border-richblack-600'>
                <h2 className='text-3xl w-[80%] '>Got a Idea? We’ve got the skills. Let’s team up</h2>
