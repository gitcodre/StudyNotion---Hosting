...
const VideoDetails = () => {
  ...
  // Video Daalna hai url mei se nikal ke id aur uska data nikalna hai 
  useEffect(() => {
    ;(async () => {
      ...
      else 
      {
        ...
        // Filter Data mei jo mere url mei sectionId tha uska Particular section pura mil jaayega
  ...
  const goToNextVideo = () => {
    ...
    if (currentSubSectionIndx !== noOfSubsections - 1) {
      // Same section mei Next pr jaana hai to iska mtlb sirf subSection change hoga
    ...
    {
      // Different section mei 1st video pr aana hai to isme section aur subSection dono change hoga
  ...
  const goToPrevVideo = () => {
    ...
    if (currentSubSectionIndx !== 0) {
      // Same Subsection mei peeche aana hai to isme sirf subsection change hoga
        ...
        >
          ...
          {videoEnded && (
            ...
            >
              ...
              {/* Disabled loading means jb Loading phase hai tb button ko disabled kr do */}
              {/* Rewatch Button */}
              <IconBtn
                disabled={loading}
                onclick={() => {
              ...
              <div className="mt-10 flex min-w-[250px] justify-center gap-x-4 text-xl">
                {!isFirstVideo() && (
                  <button
                    ...
                    className="blackButton hover:scale-95 transition-all duration-200"
                  >
                    Prev
                  </button>
                )}
